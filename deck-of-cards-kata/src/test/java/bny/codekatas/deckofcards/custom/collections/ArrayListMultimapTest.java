...
public class ArrayListMultimapTest
{
    ...
    {
        this.testObj.put("A", 1);
        Assertions.assertEquals(MutableList.of(1), this.testObj.get("A"));
        Assertions.assertEquals(1, this.testObj.size());
        this.testObj.put("A", 2);
        Assertions.assertEquals(MutableList.of(1, 2), this.testObj.get("A"));
        Assertions.assertEquals(2, this.testObj.size());
        this.testObj.put("A", 1);
        Assertions.assertEquals(MutableList.of(1, 2, 1), this.testObj.get("A"));
        Assertions.assertEquals(3, this.testObj.size());
        this.testObj.put("B", 10);
        Assertions.assertEquals(MutableList.of(10), this.testObj.get("B"));
        Assertions.assertEquals(4, this.testObj.size());
        this.testObj.put("B", 11);
        Assertions.assertEquals(MutableList.of(10, 11), this.testObj.get("B"));
        Assertions.assertEquals(5, this.testObj.size());
        this.testObj.put("A", 2);
        Assertions.assertEquals(MutableList.of(1, 2, 1, 2), this.testObj.get("A"));
    ...
    public void get_putIterable()
    {
        ...
        Assertions.assertEquals(MutableList.of(1, 2, 1, 2, 3, 4), this.testObj.get("A"));
        Assertions.assertEquals(8, this.testObj.size());
    }
    ...
    public void putAll()
    {
        ...
        Assertions.assertEquals(MutableList.of(1, 2, 3), this.testObj.get("A"));
        Assertions.assertEquals(3, this.testObj.size());
        this.testObj.putAll(MutableMap.of("B", MutableList.of(10, 10)));
        Assertions.assertEquals(MutableList.of(10, 10), this.testObj.get("B"));
        Assertions.assertEquals(5, this.testObj.size());
    }
    ...
    public void remove()
    {
        Assertions.assertEquals(MutableList.empty(), this.testObj.remove("A"));
        this.testObj.putAll(MutableMap.of("A", MutableList.of(1, 2, 3)));
        this.testObj.putAll(MutableMap.of("B", MutableList.of(10, 10)));
        Assertions.assertEquals(5, this.testObj.size());
    ...
    public void remove_keyValue()
    {
        ...
        Assertions.assertEquals(MutableList.of(2, 3, 1), this.testObj.get("A"));
        Assertions.assertEquals(5, this.testObj.size());
        this.testObj.remove("B", 10);
        MutableList<Integer> getForB = this.testObj.get("B");
        Assertions.assertEquals(MutableList.of(10), getForB);
        Assertions.assertEquals(4, this.testObj.size());
        this.testObj.remove("B", 10);
        Assertions.assertEquals(MutableList.empty(), getForB);
        Assertions.assertEquals(3, this.testObj.size());
    ...
    public void hashCodeEquals()
    {
        ...
        ArrayListMultimap<String, Integer> other = ArrayListMultimap.newMultimap();
